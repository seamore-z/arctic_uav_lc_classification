...
class Configuration:
    def __init__(self):
        ...
        self.base_dir = '/projectnb/modislc/users/seamorez/HLS_FCover/UAV/TOR/CA_TOR_KOMR_RGB_20180805/'
        self.image_type = '.png'
        self.r_fn = 'red'
        self.g_fn = 'grn'
        self.b_fn = 'blu'
        ...
        # Shape of the input data, height*width*channel; Here channels are r, g, and b
